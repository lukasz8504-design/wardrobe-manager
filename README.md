...
7. **Porównanie czasów** - Przy restarcie aplikacji system porówna czasy włożenia JIG z aktualnym czasem i automatycznie obliczy pozostały czas dla każdego JIG
